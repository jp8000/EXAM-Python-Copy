...
users = UserInfo.from_file("test_txt_files/test_UserInfo.txt") #creates a list of UserInfo objects by calling the from_file class method of the UserInfo class.
accounts = OpeningAccountData.from_file("test_txt_files/test_OpeningAccountsData.txt") #creates a list of OpeningAccountData objects by calling the from_file class method of the OpeningAccountData class.
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if not matched:
            ...
            continue
        # if the user's ID number does not match send user the start
        ...
        if user_choice == "1": #DEPOSIT
                    ...
                    if i+1 == account_choice:
                        for account in accounts:
                            if account.account_number == account_number:
                                ...
                                update_balance_file('test_txt_files/test_OpeningAccountsData.txt', account.account_number, account.opening_balance)
            ...
            accounts = OpeningAccountData.from_file("test_txt_files/test_OpeningAccountsData.txt")
            ...
            break
                ...
                # Prints and account details

        
    # User will now loop back to the start of the program as all the code is insise a While loop           